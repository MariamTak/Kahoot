              ...
              <ion-card-content>
                <ion-radio-group formControlName="correctChoiceIndex">
                  <ion-list lines="none" formArrayName="choices">
                    ...
                    @for (choice of getChoices($index).controls; track $index; let first = $first; let idx = $index) {
                      <ion-item [formGroupName]="idx">
                        <ion-input
                        ...
                        @if (!first) {
                          <ion-button fill="clear" slot="end" color="medium" (click)="removeChoice($index, idx)">
                            <ion-icon name="remove-outline"></ion-icon>
                          </ion-button>
                        } @else {
                ...
                <ion-button (click)="addChoice($index)" expand="full">Add choice</ion-button>
              </ion-card-content>
            </ion-card>
          </ion-col>
        }
